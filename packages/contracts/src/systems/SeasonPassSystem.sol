...
import { SeasonPassIndex, SeasonPassConfig, SeasonPassLastSaleAt, Config, SeasonPassSale } from "../codegen/index.sol";
import { hasSeasonPass } from "../libraries/hasToken.sol";
import { DENOMINATOR } from "../libraries/LibPool.sol";
import { SEASON_PASS_NAMESPACE, SEASON_PASS_PRICE_DECREASE_DENOMINATOR } from "../libraries/constants.sol";
...
contract SeasonPassSystem is System {
  ...
  function buySeasonPass(address account) public payable worldUnlocked {
    ...
    // Mint season pass
    IERC721Mintable token = IERC721Mintable(Config.getSeasonPassToken());
